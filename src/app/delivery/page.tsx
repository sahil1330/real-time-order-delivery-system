    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white shadow rounded-lg p-6 mb-8">
          <h2 className="text-lg font-medium text-gray-900 mb-4">Active Deliveries</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white shadow rounded-lg p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Upcoming Orders</h2>
            <div className="text-gray-600">
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="text-gray-600">
              ...
              <p className="mb-2">
                <span className="font-medium">Account Type:</span> Delivery Person
              </p>
              <p className="mb-4">
